...
sed -e '/\[Install\]/a\' -e 'Alias=mariadb.service mysqld.service mysql.service mdb.service' -i /etc/systemd/system/uny-mariadb.service
...
systemctl enable uny-mariadb
systemctl start uny-mariadb
